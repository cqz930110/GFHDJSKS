...
+ (void)initialize
{
    ...
    cell.leftBubbleMargin = UIEdgeInsetsMake(6, 15, 8, 10);
    cell.rightBubbleMargin = UIEdgeInsetsMake(6, 10, 8, 15);
...
//                _bubbleView.textLabel.textColor = model.isSender?[UIColor whiteColor]:[UIColor blackColor];
            }
                break;
