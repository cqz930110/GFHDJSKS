...
@class ProjectDetailsWebViewController;
...
@property (nonatomic,weak)WeiProjectDetailsViewController *delegates;
@property (nonatomic,weak)ProjectDetailsWebViewController *delegatesd;
@end
