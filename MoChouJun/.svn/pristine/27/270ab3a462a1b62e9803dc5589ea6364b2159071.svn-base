...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _photoButton.titleLabel.font = [UIFont systemFontOfSize:13];
    [_photoButton setTitleColor:[UIColor colorWithHexString:@"#6E6E6E"] forState:UIControlStateNormal];
    _photoButton.imageEdgeInsets = UIEdgeInsetsMake(-18, 0, 0, -26);
    _photoButton.titleEdgeInsets = UIEdgeInsetsMake(48, -24, 0, 16);
    [_scrollview addSubview:_photoButton];
    
    _takePicButton =[UIButton buttonWithType:UIButtonTypeCustom];
    [_takePicButton setFrame:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE, 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    [_takePicButton setImage:[UIImage imageNamed:@"chat_camera"] forState:UIControlStateNormal];
    [_takePicButton addTarget:self action:@selector(takePicAction) forControlEvents:UIControlEventTouchUpInside];
    _takePicButton.tag = MOREVIEW_BUTTON_TAG + 1;
    _maxIndex = 1;
    [_takePicButton setTitle:@"照片" forState:UIControlStateNormal];
    _takePicButton.titleLabel.font = [UIFont systemFontOfSize:13];
    [_takePicButton setTitleColor:[UIColor colorWithHexString:@"#6E6E6E"] forState:UIControlStateNormal];
    _takePicButton.imageEdgeInsets = UIEdgeInsetsMake(-18, 0, 0, -26);
    _takePicButton.titleEdgeInsets = UIEdgeInsetsMake(48, -24, 0, 16);
