...
//            overlayView.labIndex.text = [NSString stringWithFormat:@"%d", asset.index + 1];
            ...
            textAttach.image = [UIImage imageNamed:@"optionPay"];
            
            // 2> 使用文本附件创建属性文本
            NSAttributedString *strA = [NSAttributedString attributedStringWithAttachment:textAttach];
            overlayView.labIndex.attributedText = strA;
        } else {
            if (overlayImage == nil) {
...
//    }
	...
	CGRect frame = CGRectMake(4, 2, (self.bounds.size.width - 20) / 4, 75);
...
//                [overlayView setIndex:asset.index+1];
                [overlayView setIndexImage:[UIImage imageNamed:@"optionPay"]];
