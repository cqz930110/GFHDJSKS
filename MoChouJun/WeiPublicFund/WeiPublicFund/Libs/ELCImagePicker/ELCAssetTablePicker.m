...
- (void)viewDidLoad
{
    ...
    if (self.immediateReturn) {
        ...
        PSBarButtonItem *doneButtonItem = [PSBarButtonItem itemWithTitle:@"完成" barStyle:PSNavItemStyleDone target:self action:@selector(doneAction:)];
...
//        [self.navigationItem setTitle:NSLocalizedString(@"Loading...", nil)];
    ...
    PSBarButtonItem *item = [PSBarButtonItem itemWithImageName:@"nav_back_normal" highLightImageName:nil selectedImageName:nil target:self action:@selector(back)];
    self.navigationItem.leftBarButtonItem = item;
    
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 44, 44)];
    titleLabel.textColor = [UIColor colorWithHexString:@"#2B2B2B"];
    titleLabel.text = @"照片";
...
//            UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width / 2, 0, 44, 44)];
//            titleLabel.textColor = [UIColor colorWithHexString:@"#2B2B2B"];
//            titleLabel.text = @"照片";
