...
//    [EaseMob sharedInstance].chatManager.isAutoDeleteConversationWhenLeaveGroup = YES;
    //启动easemob sdk
...
-(void)willAutoLoginWithInfo:(NSDictionary *)loginInfo error:(EMError *)error
{
    ...
    if (error) {
//        alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"自动登录失败." delegate:nil cancelButtonTitle:@"好的" otherButtonTitles:nil, nil];
...
//        [MBProgressHUD showMessag:@"自动登录中..." toView:nil];
