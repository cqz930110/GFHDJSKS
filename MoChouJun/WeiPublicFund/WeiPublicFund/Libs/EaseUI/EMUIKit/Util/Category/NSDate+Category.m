 ...
 *  @return 格式化日期描述
 */
+ (NSString *)formattedDataDescriptionFromDataString:(NSString *)string withFormat:(NSString *)formatString
{
    NSDate *date = [NSDate dateFromString:string withFormat:formatString];
